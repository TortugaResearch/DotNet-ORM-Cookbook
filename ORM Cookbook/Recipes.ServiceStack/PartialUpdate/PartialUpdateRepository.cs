...
{
    public class PartialUpdateRepository : IPartialUpdateRepository<EmployeeClassificationPartial>
    {
        private readonly IDbConnectionFactory _dbConnectionFactory;

        public PartialUpdateRepository(IDbConnectionFactory dbConnectionFactory)
        {
