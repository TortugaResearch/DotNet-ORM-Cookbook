...
namespace LLBLGenPro.OrmCookbook.EntityClasses
{
	...
	[Serializable]
	public partial class DivisionEntity : CommonEntityBase, IDivision
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public DivisionEntity():base("DivisionEntity")
		{
		...
		public DivisionEntity(IEntityFields2 fields):base("DivisionEntity")
		{
		...
		public DivisionEntity(IValidator validator):base("DivisionEntity")
		{
		...
		public DivisionEntity(System.Int32 divisionKey):base("DivisionEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this DivisionEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public DivisionEntity(System.Int32 divisionKey, IValidator validator):base("DivisionEntity")
		{
			InitClassEmpty(validator, null);
			this.DivisionKey = divisionKey;
		}
		...
		protected DivisionEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_departments = (EntityCollection<DepartmentEntity>)info.GetValue("_departments", typeof(EntityCollection<DepartmentEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			...
			{
				case "Departments":
					this.Departments.Add((DepartmentEntity)entity);
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Departments":
					toReturn.Add(Relations.DepartmentEntityUsingDivisionKey);
					break;
				default:
					break;				
			}
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			...
			{
				case "Departments":
					this.Departments.Add((DepartmentEntity)relatedEntity);
					break;
				default:
					break;
			}
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			...
			{
				case "Departments":
					this.PerformRelatedEntityRemoval(this.Departments, relatedEntity, signalRelatedEntityManyToOne);
					break;
				default:
					break;
			}
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_departments", ((_departments!=null) && (_departments.Count>0) && !this.MarkedForDeletion)?_departments:null);
			}
		...
		{
			return new DivisionRelations().GetAllRelations();
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoDepartments()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(DepartmentFields.DivisionKey, null, ComparisonOperator.Equal, this.DivisionKey));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(DivisionEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._departments);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._departments = (EntityCollection<DepartmentEntity>) collectionsQueue.Dequeue();
		...
		{
			bool toReturn = false;
			toReturn |=(this._departments != null);
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("Departments", _departments);
			return toReturn;
		}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("DivisionKey", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("DivisionName", fieldHashtable);
		}
		#endregion
		...
		public  static DivisionRelations Relations
		{
			get	{ return new DivisionRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDepartments
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<DepartmentEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DepartmentEntityFactory))), (IEntityRelation)GetRelationsForField("Departments")[0], (int)LLBLGenPro.OrmCookbook.EntityType.DivisionEntity, (int)LLBLGenPro.OrmCookbook.EntityType.DepartmentEntity, 0, null, null, null, null, "Departments", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <remarks>Mapped on  table field: "Division"."DivisionKey"<br/>
		...
		/// <remarks>Mapped on  table field: "Division"."DivisionName"<br/>
		...
		public virtual EntityCollection<DepartmentEntity> Departments
		{
			get { return GetOrCreateEntityCollection<DepartmentEntity, DepartmentEntityFactory>("Division", true, false, ref _departments);	}
		}
		...
		{ 
			get { return (int)LLBLGenPro.OrmCookbook.EntityType.DivisionEntity; }
		}
