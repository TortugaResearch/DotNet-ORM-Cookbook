...
namespace LLBLGenPro.OrmCookbook.EntityClasses
{
	...
	[Serializable]
	public partial class EmployeeClassificationEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public EmployeeClassificationEntity():base("EmployeeClassificationEntity")
		{
		...
		public EmployeeClassificationEntity(IEntityFields2 fields):base("EmployeeClassificationEntity")
		{
		...
		public EmployeeClassificationEntity(IValidator validator):base("EmployeeClassificationEntity")
		{
		...
		public EmployeeClassificationEntity(System.Int32 employeeClassificationKey):base("EmployeeClassificationEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this EmployeeClassificationEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EmployeeClassificationEntity(System.Int32 employeeClassificationKey, IValidator validator):base("EmployeeClassificationEntity")
		{
			InitClassEmpty(validator, null);
			this.EmployeeClassificationKey = employeeClassificationKey;
		}
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Employees":
					toReturn.Add(Relations.EmployeeEntityUsingEmployeeClassificationKey);
					break;
				default:
					break;				
			}
		...
		{
			return new EmployeeClassificationRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoEmployees()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EmployeeFields.EmployeeClassificationKey, null, ComparisonOperator.Equal, this.EmployeeClassificationKey));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EmployeeClassificationEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EmployeeClassificationName", fieldHashtable);
		}
		#endregion
		...
		public  static EmployeeClassificationRelations Relations
		{
			get	{ return new EmployeeClassificationRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), (IEntityRelation)GetRelationsForField("Employees")[0], (int)LLBLGenPro.OrmCookbook.EntityType.EmployeeClassificationEntity, (int)LLBLGenPro.OrmCookbook.EntityType.EmployeeEntity, 0, null, null, null, null, "Employees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <remarks>Mapped on  table field: "EmployeeClassification"."EmployeeClassificationKey"<br/>
		...
		/// <remarks>Mapped on  table field: "EmployeeClassification"."EmployeeClassificationName"<br/>
		...
		{
			get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("EmployeeClassification", true, false, ref _employees);	}
		}
		...
		{ 
			get { return (int)LLBLGenPro.OrmCookbook.EntityType.EmployeeClassificationEntity; }
		}
