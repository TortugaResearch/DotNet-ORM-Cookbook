...
namespace LLBLGenPro.OrmCookbook.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		{
			return GeneralEntityFactory.Create((LLBLGenPro.OrmCookbook.EntityType)entityTypeValue);
		}
	...
	public partial class DivisionEntityFactory : EntityFactoryBase2<DivisionEntity> {
		...
		/// <summary>Creates a new DivisionEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new DivisionEntity(fields);
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewDivisionUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
		#region Included Code
	...
	public partial class EmployeeClassificationEntityFactory : EntityFactoryBase2<EmployeeClassificationEntity> {
		...
		/// <summary>Creates a new EmployeeClassificationEntity instance but uses a special constructor which will set the Fields object of the new IEntity2 instance to the passed in fields object.</summary>
		/// <param name="fields">Populated IEntityFields2 object for the new IEntity2 to create</param>
		/// <returns>Fully created and populated (due to the IEntityFields2 object) IEntity2 object</returns>
		public override IEntity2 Create(IEntityFields2 fields) {
			IEntity2 toReturn = new EmployeeClassificationEntity(fields);
			// __LLBLGENPRO_USER_CODE_REGION_START CreateNewEmployeeClassificationUsingFields
			// __LLBLGENPRO_USER_CODE_REGION_END
			return toReturn;
		}
		#region Included Code
		...
		public static IEntity2 Create(LLBLGenPro.OrmCookbook.EntityType entityTypeToCreate)
		{
			...
			switch(entityTypeToCreate)
			{
				...
				case LLBLGenPro.OrmCookbook.EntityType.DivisionEntity:
					factoryToUse = new DivisionEntityFactory();
					break;
				...
				case LLBLGenPro.OrmCookbook.EntityType.EmployeeClassificationEntity:
					factoryToUse = new EmployeeClassificationEntityFactory();
					break;
			}
	...
	public static class EntityFactoryFactory
	{
		...
		{
			Array entityTypeValues = Enum.GetValues(typeof(LLBLGenPro.OrmCookbook.EntityType));
			foreach(int entityTypeValue in entityTypeValues)
			{
				IEntity2 dummy = GeneralEntityFactory.Create((LLBLGenPro.OrmCookbook.EntityType)entityTypeValue);
	...
	public class ElementCreator : ElementCreatorBase, IElementCreator2
	{
		...
		/// <summary>Implementation of the routine which gets the factory of the Entity type with the LLBLGenPro.OrmCookbook.EntityType value passed in</summary>
		/// <param name="entityTypeValue">The entity type value.</param>
		/// <returns>the entity factory of the entity type or null if not found</returns>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue)
		{
			return EntityFactoryFactory.GetFactory((LLBLGenPro.OrmCookbook.EntityType)entityTypeValue);
		}
