...
{
	public class ModelWithChildrenRepository : IModelWithChildrenRepository<ProductLineEntity, ProductEntity>
	{
		...
		public void UpdateAlt(ProductLineEntity productLine)
		{
			if(productLine == null)
				throw new ArgumentNullException(nameof(productLine), $"{nameof(productLine)} is null.");
