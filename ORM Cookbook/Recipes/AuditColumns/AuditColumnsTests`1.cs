...
namespace Recipes.AuditColumns
{
       ...
       where TDepartment : class, IDepartment, new()
    {
        ...
        public void CreateAndUpdate()
        {
            ...
            version1.DepartmentName = "Updated " + DateTime.Now.Ticks.ToString();
            repository.UpdateDepartment(version1, user2);

            var version2 = repository.GetDepartment(departmentKey);
            Assert.AreEqual(version1.DepartmentName, version2.DepartmentName);
