   ...
   where TEmployeeSimple : class, IEmployeeSimple, new()
{
    ...
    public void InsertBatchWithUpdate()
    {
        ...
        foreach (var original in originals)
            Assert.IsGreaterThanOrEqualTo(1000, original.EmployeeKey, "keys under 1000 were not generated by the database");
    }
    ...
    {
        Assert.HasCount(originals.Count, actuals, "Wrong number of rows created or returned");
        foreach (var original in originals)
        {
            var actual = actuals.Single(x => x.MiddleName == original.MiddleName);
            Assert.IsGreaterThanOrEqualTo(1000, actual.EmployeeKey, "keys under 1000 were not generated by the database");
