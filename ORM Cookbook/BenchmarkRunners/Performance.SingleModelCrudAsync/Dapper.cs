...
namespace Performance
{
    partial class Benchmarks
    {
        ...
        /// </summary>
        [Benchmark]
        public Task Dapper_SingleModelCrudAsyncTests_CreateAndDeleteByModel()
        {
            var test = new SingleModelCrudAsyncTests();
        ...
        /// </summary>
        [Benchmark]
        public Task Dapper_SingleModelCrudAsyncTests_CreateAndDeleteByKey()
        {
            var test = new SingleModelCrudAsyncTests();
        ...
        /// </summary>
        [Benchmark]
        public Task Dapper_SingleModelCrudAsyncTests_GetAll()
        {
            var test = new SingleModelCrudAsyncTests();
        ...
        /// </summary>
        [Benchmark]
        public Task Dapper_SingleModelCrudAsyncTests_GetByKey()
        {
            var test = new SingleModelCrudAsyncTests();
        ...
        /// </summary>
        [Benchmark]
        public Task Dapper_SingleModelCrudAsyncTests_CreateAndUpdate()
        {
            var test = new SingleModelCrudAsyncTests();
