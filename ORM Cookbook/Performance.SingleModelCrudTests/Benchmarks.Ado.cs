...
namespace Performance
{
    partial class Benchmarks
    {
        ...
        [Benchmark]
        public Task Ado_SingleModelCrudAsyncTests_CreateAndReadBack()
        {
        ...
        /// </summary>
        [Benchmark]
        public Task Ado_SingleModelCrudAsyncTests_CreateAndDeleteByModel()
        {
            var test = new SingleModelCrudAsyncTests();
        ...
        /// </summary>
        [Benchmark]
        public Task Ado_SingleModelCrudAsyncTests_CreateAndDeleteByKey()
        {
            var test = new SingleModelCrudAsyncTests();
        ...
        /// </summary>
        [Benchmark]
        public Task Ado_SingleModelCrudAsyncTests_GetAll()
        {
            var test = new SingleModelCrudAsyncTests();
        ...
        /// </summary>
        [Benchmark]
        public Task Ado_SingleModelCrudAsyncTests_GetByKey()
        {
            var test = new SingleModelCrudAsyncTests();
        ...
        /// </summary>
        [Benchmark]
        public Task Ado_SingleModelCrudAsyncTests_CreateAndUpdate()
        {
            var test = new SingleModelCrudAsyncTests();
