...
using Recipes.RepoDb.SingleModelCrud;
...
namespace Performance
{
    partial class Benchmarks
    {
        ...
        [Benchmark]
        public void RepoDb_SingleModelCrudTests_CreateAndReadBack()
        {
        ...
        /// </summary>
        [Benchmark]
        public void RepoDb_SingleModelCrudTests_CreateAndDeleteByModel()
        {
            var test = new SingleModelCrudTests();
        ...
        /// </summary>
        [Benchmark]
        public void RepoDb_SingleModelCrudTests_CreateAndDeleteByKey()
        {
            var test = new SingleModelCrudTests();
        ...
        /// </summary>
        [Benchmark]
        public void RepoDb_SingleModelCrudTests_GetAll()
        {
            var test = new SingleModelCrudTests();
            test.GetAll();
        }
        ...
        /// </summary>
        [Benchmark]
        public void RepoDb_SingleModelCrudTests_GetByKey()
        {
            var test = new SingleModelCrudTests();
            test.GetByKey();
        }
        ...
        /// </summary>
        [Benchmark]
        public void RepoDb_SingleModelCrudTests_CreateAndUpdate()
        {
            var test = new SingleModelCrudTests();
