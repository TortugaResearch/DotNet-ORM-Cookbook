...
namespace Recipes.Ado.ModelWithChildren
{
    public class ModelWithChildrenRepository : IModelWithChildrenRepository<ProductLine, Product>
    {
        ...
        public ModelWithChildrenRepository(string connectionString)
        {
        ...
        public int Create(ProductLine productLine)
        {
            ...
            const string sqlA = "INSERT INTO Production.ProductLine ( ProductLineName ) OUTPUT Inserted.ProductLineKey VALUES (@ProductLineName);";

            using (var con = OpenConnection())
            {
                using (var cmd = new SqlCommand(sqlA, con))
                {
