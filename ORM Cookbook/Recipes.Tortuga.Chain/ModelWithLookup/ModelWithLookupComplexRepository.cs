...
{
    public class ModelWithLookupComplexRepository : IModelWithLookupComplexRepository<EmployeeComplex>
    {
        ...
        public ModelWithLookupComplexRepository(SqlServerDataSource dataSource)
        {
